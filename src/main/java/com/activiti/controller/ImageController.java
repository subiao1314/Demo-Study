...
public class ImageController {
    ...
    * 读取带跟踪的图片
    */
   @RequestMapping("/getCurrentImage")
   public void test(HttpServletResponse response,@RequestParam("processInstanceId") String processInstanceId) throws Exception {
      ...
      /* for(HistoricActivityInstance tempActivity : highLightedActivitList){
       ...
       //中文显示的是口口口，设置字体就好了
       InputStream imageStream = diagramGenerator.generateDiagram(bpmnModel, "png", highLightedActivitis,highLightedFlows,"KaiTi Regular","KaiTi Regular","KaiTi Regular",null,1.0);
       //单独返回流程图，不高亮显示
