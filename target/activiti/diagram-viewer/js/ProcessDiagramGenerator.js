...
var ProcessDiagramGenerator = {	
	...
	setHighLights: function(highLights){
		if (highLights[1].processDefinitionId == undefined) {
			//console.error("Process instance " + highLights.processInstanceId + " doesn't exist");
			return;
		}
		
		var processDiagram = this.getProcessDiagram(highLights[1].processDefinitionId);
		...
		for (var i in highLights[1].activities) {
			var activityId = highLights[1].activities[i];
			processDiagramCanvas.highLightActivity(activityId);
		}
		
		if (highLights[0].length>0) {
			//for (var j=0;j<highLights[0].length;j++) {
				processDiagramCanvas.highLightHisActivities(highLights[0]);
			//}
		}
		
		// TODO: remove highLightes from all flows before set new highLight
		for (var i in highLights[1].flows) {
			var flowId = highLights[1].flows[i];
	...
	//历史节点。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。
//	setHisHighLights: function(hisHighLights){
//		if (hisHighLights.processDefinitionId == undefined) {
//			//console.error("Process instance " + highLights.processInstanceId + " doesn't exist");
//			return;
//		}
//		
//		var processDiagram = this.getProcessDiagram(hisHighLights.processDefinitionId);
//		if (processDiagram == undefined) {
//			//console.error("Process diagram " + highLights.processDefinitionId + " not found");
//			return;
//		}
...
//		
//		// TODO: remove highLightes from all activities before set new highLight
//		for (var i in hisHighLights.activities) {
//			var activityId = hisHighLights.activities[i];
//			processDiagramCanvas.highLightActivity(activityId);
//		}
//		
//		// TODO: remove highLightes from all flows before set new highLight
//		for (var i in hisHighLights.flows) {
//			var flowId = hisHighLights.flows[i];
//			var object = processDiagramCanvas.g.getById(flowId);
//			var flow = object.data("contextObject");
//			flow.isHighLighted = true;
//			processDiagramCanvas.highLightFlow(flowId);
...
//	},
//	
//	drawHisHighLights: function(processInstanceId) {
//		ActivitiRest.getHisHighLights(this._drawHisHighLights);
//	},
//	_drawHisHighLights: function() {
//		var highLights = this.highLights;
//		ProcessDiagramGenerator.setHighLights(highLights);
//	},
	//历史节点。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。
